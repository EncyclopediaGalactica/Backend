...
)
{
    ...
    private Either<ErrorResult, RelationTypeResult> MapToRelationTypeResult(
        ...
        Either<ErrorResult, RelationTypeResult>.Right(savedResult.MapToRelationTypeResult());
    ...
    private Either<ErrorResult, RelationType> MapToRelationType(
        ...
        Either<ErrorResult, RelationType>.Right(context.Payload.MapToRelationType());

namespace EncyclopediaGalactica.Core;
...
public class DocumentDomainDbContext : DbContext
{
    ...
    public DbSet<Application.Application> Applications => Set<Application.Application>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(ApplicationDatabaseConfiguration).Assembly);
